...
module.exports = function (libraries) {
    ...
    Apio.io.on("apio_autoinstall_service", function (data) {
        ...
        console.log("SONO DENTRO ALL'EVENTO SULLA SOCKET APIO_AUTOINSTALL_SERVICE");
        if (data) {
            var appId = data;
    ...
    socketServer.on("connection", function (socket) {
        console.log("autoinstall client connected");
