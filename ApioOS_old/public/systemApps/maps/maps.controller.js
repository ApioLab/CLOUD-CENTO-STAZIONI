...
angular.module('ApioApplication').service('lazyLoadApi', function lazyLoadApi($window, $q) {
...
}).controller('ApioMapsController', ['$scope', '$http', 'socket', 'objectService', 'currentObject', "$timeout", "planimetryService", "FileUploader", "lazyLoadApi", "$mdDialog", '$compile', '$mdSidenav', function ($scope, $http, socket, objectService, currentObject, $timeout, planimetryService, FileUploader, lazyLoadApi, $mdDialog, $compile ,$mdSidenav) {
    ...
    socket.on("apio_server_new", function (data) {
        objectService.getById(data).then(function (d) {
            $scope.objects.push(d.data);
            $scope.asMarker[data] = false;
            if (!$scope.$$phase) {
                $scope.$apply();
            }
        });
    ...
    socket.on("apio_server_update", function (data) {
        ...
        console.log("apio_server_update: ", data);
...
//questa funzione viene utilizzata per aggiungere un marker a seguito di un click su una delle icone mostrate nella barra Lista Marker
        ...
        $http.get('/apio/database/getObjects').success(function (d) {
        ...
        $scope.stations = [
	        {
		        apioId : "af687d75-7d4a-4437-95ce-e6795114da29",
		        name : "L'Aquila",
		        type: "Stazione",
		        ragion:{
			        name:"Abruzzo",
	        ...
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da30",
		        name : "Chieti",
		        type: "Stazione",
		        ragion:{
			        name:"Abruzzo",
		        ...
		        geoLat : "42.35682874258882",
		        geoLng : "14.138272872964308"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da29",
		        ...
		        geoLat : "42.468225890916884",
		        geoLng : "14.204212245286385"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da2",
		        ...
		        geoLat : "40.6296122003561",
		        geoLng : "15.806788274205019"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Catanzaro Lido",
		        type: "Stazione",
		        ragion:{
			        name:"Calabria",
		        ...
		        geoLat : "38.82192153232994",
		        geoLng : "16.612817795001774"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "38.103549738578316",
		        geoLng : "15.636262492642345"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "38.21651422112524",
		        geoLng : "15.634556432454133"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Benevento",
		        ...
		        geoLat : "41.1417710662454",
		        geoLng : "14.769546870621753"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Caserta",
		        ...
		        geoLat : "41.06875629759532",
		        geoLng : "14.328119697161696"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "40.822236159283236",
		        geoLng : "14.194760209227411"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "40.831529623779865",
		        geoLng : "14.218611810173002"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Salerno",
		        ...
		        geoLat : "40.6751617484158",
		        geoLng : "14.772432549702899"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Civitavecchia",
		        ...
		        geoLat : "42.08836913374631",
		        geoLng : "11.798008907774147"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Formia-Gaeta",
		        ...
		        geoLat : "41.25883969526513",
		        geoLng : "13.606328876686462"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Orte",
		        ...
		        geoLat : "42.43740689002856",
		        geoLng : "12.408762671181307"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Roma Ostiense",
		        ...
		        geoLat : "41.872799427652666",
		        geoLng : "12.48396187301637"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "41.872324911915115",
		        geoLng : "12.465996431265467"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Ancona",
		        ...
		        geoLat : "43.60744832912659",
		        geoLng : "13.497756972283241"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Ascoli Piceno",
		        ...
		        geoLat : "42.85537377749932",
		        geoLng : "13.587938322020705"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Macerata",
		        ...
		        geoLat : "43.293182354474844",
		        geoLng : "13.455395624432754"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Pesaro",
		        ...
		        geoLat : "43.906113055789895",
		        geoLng : "12.90490081029452"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Campobasso",
		        ...
		        geoLat : "41.55828977709883",
		        geoLng : "14.663846835582035"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Termoli",
		        ...
		        geoLat : "42.000773395507736",
		        geoLng : "14.992841440492839"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Barletta",
		        ...
		        geoLat : "41.315500779087365",
		        geoLng : "16.278622578929117"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Brindisi",
		        ...
		        geoLat : "40.63431218450214",
		        geoLng : "17.93928659163157"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Foggia",
		        ...
		        geoLat : "41.46560103676462",
		        geoLng : "15.555550814004164"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Lecce",
		        ...
		        geoLat : "40.346260233333794",
		        geoLng : "18.16506108124122"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Taranto",
		        ...
		        geoLat : "40.483669292707695",
		        geoLng : "17.2241331225282"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Cagliari",
		        ...
		        geoLat : "39.21587076530411",
		        geoLng : "9.108549321230726"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "38.13238777830865",
		        geoLng : "13.341976901223347"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "37.50675177328435",
		        geoLng : "15.099929382208984"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        ...
		        geoLat : "38.185471317849846",
		        geoLng : "15.561025725148511"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Assisi",
		        ...
		        geoLat : "43.059033193501776",
		        geoLng : "12.585400855819671"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Foligno",
		        ...
		        geoLat : "42.95419462639327",
		        geoLng : "12.710870678179162"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Perugia",
		        ...
		        geoLat : "43.103888092272186",
		        geoLng : "12.376007354088188"    
	        },
	        {
	        	apioId : "af687d75-7d4a-4437-95ce-e6795114da",
		        name : "Terni",
		        ...
		        geoLat : "42.57047023545442",
		        geoLng : "12.651569179814373"    
	        }
        ...
        $scope.showThisStation = function(selectedRagion){
	        console.log("showThisStation!");
	        if($scope.selectRegion != selectedRagion.name){
	        	$scope.selectRegion = selectedRagion.name;
	        } else {
		        $scope.selectRegion = "";
	        }
        }
        
        $scope.goTo = function(a,event){
	        console.log("goTo!");
	        event.stopPropagation();
	        //$scope.objects = data;
	        //console.log("OBJECTS: ",data)
	        //$scope.changePlace()
	        //$scope.selectRegion = a.ragion.name;
	        var place = {lat:Number(a.geoLat),lng:Number(a.geoLng)}
	    	map.setCenter(place);
        ...
        $scope.newObject = function(){
        	var s = $scope.$new();
	        $mdDialog.show({
                templateUrl: "/applications/newfile/NewObject/template_modal.html",
                controller: "modalNewObject",
        ...
        $scope.showOnly = function(cat){
	        //alert(cat)
	        if(cat=="Tutti"){
	        	for (var s in $scope.objects) {
	        	allMarkers[$scope.objects[s].marker.id].setMap(null);
	        	allMarkers[$scope.objects[s].marker.id].setMap(map);
                }
		        
	        } else {
		      for (var s in $scope.objects) {
                if ($scope.objects[s].appId != cat) {
