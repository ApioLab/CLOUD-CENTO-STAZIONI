...
angular.module("ApioApplication").controller("modalasset/Anti-incendio/Rivelatori_Fumi", ["$scope", "$http", "$mdDialog", "socket", function ($scope, $http, $mdDialog, socket) {
    var d = new Date();
    	...
    	if($scope.step==0){
	    	...
	    	$http.get("/apio/user/getSessionComplete").success(function (session) {
	            ...
	            $scope.modalData.extraData = {
	                ...
	                peso: $scope.peso,
	                category: "Anti-incendio",
	                objectType: "Rivelatori_Fumi"
