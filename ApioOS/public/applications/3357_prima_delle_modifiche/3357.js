...
app.controller("defaultController", ["$scope", "$mdDialog", "currentObject", "$http", "socket", function ($scope, $mdDialog, currentObject, $http, socket) {
    ...
    //         templateUrl: "/applications/3357/template/new_ticket.html",
    //         parent: angular.element(document.getElementById("ApioApplication3357")),
    //         targetEvent: ev,
    ...
    //         bindToController: true,
    //         templateUrl: "/applications/3357/template/view_ticket.html",
    //         parent: angular.element(document.getElementById("ApioApplication3357")),
    //         targetEvent: ev,
    //         clickOutsideToClose: true,
    //         fullscreen: true
