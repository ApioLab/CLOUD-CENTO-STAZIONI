...
angular.module("ApioApplication").controller("modalasset/Anti-incendio/Quadri_di_Sollevamento_Pompe", ["$scope", "$http", "$mdDialog", "socket", function ($scope, $http, $mdDialog, socket) {
