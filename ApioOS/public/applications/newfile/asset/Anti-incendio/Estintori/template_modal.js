...
angular.module("ApioApplication").controller("modalasset/Anti-incendio/Estintori", ["$scope", "$http", "$mdDialog", "socket", function ($scope, $http, $mdDialog, socket) {
	var d = new Date();
