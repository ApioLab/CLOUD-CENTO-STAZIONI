...
angular.module("ApioApplication").controller("modalasset/Termico/Gruppi_Termici", ["$scope", "$http", "$mdDialog", "socket", function ($scope, $http, $mdDialog, socket) {
               var d = new Date();
