...
apioProperty.directive("unlimitedsensor2", ["currentObject", "socket", "$http", function (currentObject, socket, $http) {
    return {
        restrict: "E",
        replace: true,
        scope: {
        ...
        templateUrl: "apioProperties/UnlimitedSensor2/unlimitedsensor2.html",
