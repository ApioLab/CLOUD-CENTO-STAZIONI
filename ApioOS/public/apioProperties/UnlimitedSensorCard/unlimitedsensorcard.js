...
apioProperty.directive("unlimitedsensorcard", ["currentObject", "socket", "$http","$timeout", function (currentObject, socket, $http,$timeout) {
    return {
        restrict: "E",
        replace: true,
        scope: {
        ...
        templateUrl: "apioProperties/UnlimitedSensorCard/unlimitedsensorcard.html",
