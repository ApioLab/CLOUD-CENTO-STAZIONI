module.exports = {
    ...
    "zwave": {
        ...
        "Home": {
            "send": {},
            "recive": {
                "02": "(function(data){console.log('Energy');var properties = {'energy':''}; properties.energy=String(Number(data.value)); return properties;})",
                "01": "(function(data){console.log('power');var properties = {'power':''}; properties.power=String(Number(data.value)); return properties;})"
            }
        },
        "PST02-A": {
            "send": {},
            "recive": {
                "00": "(function(data){return{presence:String(data.value)}})",
                "01": "(function(data){return{battery:String(data.value)}})",
                "02": "(function(data){return{access_control:String(data.value)}})",
                "03": "(function(data){return{temperature:((Number(data.value)-32)/1.8).toFixed(2)}})",
                "04": "(function(data){return{brightness:String(data.value)}})"
            }
        },
        "ZThermostat014G0013": {
            "send": {
                "setPoint": "(function(data){var o={};o.classZ=67;o.index=1;o.instance=1;o.value=Number(data.message.value);return o})",
                "getBattery": "(function(data){var o={};o.classZ=128;o.index=0;o.instance=1;o.value=Number(data.message.value);return o})"
            },
            "recive": {
                "00": "(function(data){console.log('Heating 1');var properties = {'setpoint':''}; properties.setpoint=String(Number(data.value)); return properties;})",
                "01": "(function(data){console.log('battery');var properties = {'battery':''}; properties.battery=String(Number(data.value)); return properties;})"
            }
        },
        "OnOffPhilio": {
            "send": {
	            "switch_0": "(function(data){var o={};o.classZ=37;o.index=0;o.instance=2;o.value=Number(data.message.value);return o})",
	            "switch_1": "(function(data){var o={};o.classZ=37;o.index=0;o.instance=3;o.value=Number(data.message.value);return o})"
            },
            "recive": {
                "00": "(function(data){console.log('switch');var properties = {'switch':''}; properties.switch=String(Number(data.value)); return properties;})",
                "01": "(function(data){console.log('power');var properties = {'power':''}; properties.power=String(Number(data.value)); return properties;})"
        ...
        "Micro": {
            "send": {
	            "switch_0": "(function(data){var o={};o.classZ=37;o.index=0;o.instance=1;o.value=Number(data.message.value);return o})"
            },
            "recive": {
                "01": "(function(data){console.log('power');var properties = {'power':''}; properties.power=String(Number(data.value)); return properties;})"
            }
        ...
        "NQ-9121": {
            "send": {
	            "sensorType": "(function(data){var o={};o.classZ=112;o.index=2;o.instance=1;o.config=true;if(data.message.value=='Magnetic contact meter'){o.value=0;}else{o.value=1;};return o})",
	            "switch_1": "(function(data){var o={};o.classZ=37;o.index=0;o.instance=3;o.value=Number(data.message.value);return o})"
            },
            "recive": {
                "00": "(function(data){console.log('switch');var properties = {'gas':''}; properties.gas=String(Number(data.value)); return properties;})",
                "01": "(function(data){console.log('power');var properties = {'battery_level':''}; properties.battery_level=String(Number(data.value)); return properties;})"
            }
        },
        "NQ-92021": {
            "send": {
            ...
            "recive": {
	            "00": "(function(data){console.log('Energy');var properties = {'energy':''}; properties.energy=String(Number(data.value)); return properties;})",
                "01": "(function(data){console.log('power');var properties = {'battery_level':''}; properties.battery_level=String(Number(data.value)); return properties;})"
            }
        },
        "SWM01": {
            ...
            "recive": {
                "00": "(function(data){console.log('switch');var properties = {'water':''}; properties.water=String(Number(data.value)); return properties;})",
                "01": "(function(data){console.log('power');var properties = {'battery_level':''}; properties.battery_level=String(Number(data.value)); return properties;})"
            }
        },
    },
    "apio": {
        ...
        "HuaweiSUN2000": {
            "send": {},
            "recive": {
                "inverter": "(function(data) { console.log('*******data******', data); var properties = { dati: { 'PV1Voltage': '', 'PV2Voltage': '', 'PV3Voltage': '', 'PV4Voltage': '', 'PV5Voltage': '', 'PV6Voltage': '', 'PV1Current': '', 'PV2Current': '', 'PV3Current': '', 'PV4Current': '', 'PV5Current': '', 'PV6Current': '', 'activePower': '', 'uab': '', 'ubc': '', 'uca': '', 'powerFactor': '', 'cabinetTemperature': '', 'reactivePower': '', 'frequency': '', 'totalEnergy': '', 'currentDayEnergy': '', 'ia': '', 'ib': '', 'ic': '', 'totalInputPower': '', 'status': '' } }; var property = Object.keys(data.properties)[0]; if (property == 'HuaweiSUN2000') { var value = data.properties.HuaweiSUN2000.split('|'); var n = Number(value[0]); for (var h = 1; h < value.length - 1; h++) { console.log('primo valore: ', value[h][0]); if (value[h][0] == 'n') { console.log('valore negativo'); value[h] = value[h].substring(0, 0) + '-' + value[h].substring(0 + 1); } if(n>=0 && n<=5){ value[h] = (parseInt(value[h])/10).toString(); } else if(n>=6 && n<=11){ value[h] = (parseInt(value[h])/100).toString(); } else if(n==12){ value[h] = (parseInt(value[h])/1000).toString(); } else if(n>=13 && n<=15){ value[h] = (parseInt(value[h])/100).toString(); } else if(n==16){ value[h] = (parseInt(value[h])/1000).toString(); } else if(n==17){ value[h] = (parseInt(value[h])/10).toString(); } else if(n==18){ value[h] = (parseInt(value[h])/1000).toString(); } else if(n==19){ value[h] = (parseInt(value[h])/100).toString(); } else if(n==20){ value[h] = (parseInt(value[h])/100).toString(); } else if(n==21){ value[h] = (parseInt(value[h])/100).toString(); } else if(n>=22 && n<=24){ value[h] = (parseInt(value[h])/100).toString(); } else if(n==25){ value[h] = (parseInt(value[h])/1000).toString(); } else if(n==26){ value[h] = (parseInt(value[h])/1).toString(); } properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ', n); console.log('h: ', h); console.log('this property: ', properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ', properties.dati); } var key = Object.keys(properties.dati); for (var x in key) { if (properties.dati[key[x]] == '') { delete properties.dati[key[x]]; } } return properties.dati; })",
                "update": "(function(data){console.log('switch');var properties = {'switch':''}; properties.switch=String(Number(data.value)); return properties;})"
            }
        },
        "SenecaS500": {
        ...
        "ZDIN": {
            "send": {},
            "recive": {
                "energy": "(function(data) { console.log('*******data******', data); var properties = { dati: { 'puls1': '', 'puls2': '', 'puls3': '', 'puls4': '', 'puls5': '' } }; var property = Object.keys(data.properties)[0]; if (property == 'ZDIN') { var value = data.properties.ZDIN.split('|'); var n = Number(value[0]); for (var h = 1; h < value.length - 1; h++) { console.log('primo valore: ', value[h][0]); if (value[h][0] == 'n') { console.log('valore negativo'); value[h] = value[h].substring(0, 0) + '-' + value[h].substring(0 + 1); } properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ', n); console.log('h: ', h); console.log('this property: ', properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ', properties.dati); } var key = Object.keys(properties.dati); for (var x in key) { if (properties.dati[key[x]] == '') { delete properties.dati[key[x]]; } } return properties.dati; })"
            }
        },
        "SolarimetroETPT100": {
            "send": {},
            "recive": {
                "datalogger": "(function(data) { console.log('*******data******', data); var properties = { dati: { 'status': '', 'irradiation': '', 'temp1': '', 'temp2': '', 'irrValMD': '', 'temp1ValMD': '', 'temp2ValMD': '' } }; var property = Object.keys(data.properties)[0]; if (property == 'SolarimetroETPT100') { var value = data.properties.SolarimetroETPT100.split('|'); var n = Number(value[0]); for (var h = 1; h < value.length - 1; h++) { console.log('primo valore: ', value[h][0]); if (value[h][0] == 'n') { console.log('valore negativo'); value[h] = value[h].substring(0, 0) + '-' + value[h].substring(0 + 1); } if (n == 0) { value[h] = parseInt(value[h]); if(value[h] == 0){ value[h] = 'errore di calibrazione'; } else if(value[h] == 1){ value[h] = 'calibrazione OK'; } } if (n == 2 || n == 3 || n == 5 || n == 6) { value[h] = (parseInt(value[h]) / 10).toString(); } properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ', n); console.log('h: ', h); console.log('this property: ', properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ', properties.dati); } var key = Object.keys(properties.dati); for (var x in key) { if (properties.dati[key[x]] == '') { delete properties.dati[key[x]]; } } return properties.dati; })"
            }
        },
        "DIN8": {
            "send": {
        ...
        "DIN2": {
            ...
            "recive": {
                "update": "(function(data,allProperties){return data.properties;})",
                "hi": "(function(data,allProperties,Apio){console.log('DATA***',data,allProperties); return data.properties})"
            }
        },
        "DIN": {
            "send": {
    ...
    "enocean": {
        "d5-XX": {
            ...
            "recive": {
                "01": "(function(data,enocean){var contact;if(data.raw == '08'){contact = '1';} else if(data.raw == '09'){contact = '0';}console.log(data.raw);var properties = {contact: contact};return properties;})"
            }
        },
        "d2-01-0b": {
            "send": {
        ...
        "a5-08-01": {
            ...
            "recive": {
                "01": "(function(data,enocean){var bytes=[];bytes[0]=parseInt(data.raw[0]+data.raw[1],16);bytes[1]=parseInt(data.raw[2]+data.raw[3],16);bytes[2]=parseInt(data.raw[4]+data.raw[5],16);bytes[3]=parseInt(data.raw[6]+data.raw[7],16);var illuminationMaxFlow=510,temperatureMaxFlow=51;var binaryForthByte=bytes[3].toString(2);while(binaryForthByte.length<8){binaryForthByte='0'+binaryForthByte}return{illumination:String(bytes[1]*illuminationMaxFlow/255),temperature:String(bytes[2]*temperatureMaxFlow/255),pir_status:binaryForthByte[6]}})"
            }
        },
        "a5-04-02": {
            "send": {
            ...
            "recive": {
                "01": "(function(data,enocean){var bytes=[];bytes[0]=parseInt(data.raw[0]+data.raw[1],16);bytes[1]=parseInt(data.raw[2]+data.raw[3],16);bytes[2]=parseInt(data.raw[4]+data.raw[5],16);bytes[3]=parseInt(data.raw[6]+data.raw[7],16);var relHumidityMaxFlow=100,temperatureMaxFlow=60,temperatureMinFlow=-20;return{rel_humidity:String(bytes[1]*relHumidityMaxFlow/250),temperature:String((temperatureMaxFlow-temperatureMinFlow)*bytes[2]/250+temperatureMinFlow)}})"
            }
        },
        "a5-06-01": {
            "send": {
