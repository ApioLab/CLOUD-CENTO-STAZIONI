...
//     });
     ...
     */
    var PIN_22 = new Gpio(22, "out");
    PIN_22.writeSync(1);
    var PIN_23 = new Gpio(23, "in", "both");

    var PINPower3GModule = new Gpio(17, "out");
    //PINPower3GModule.writeSync(0);

    var PIN_27 = new Gpio(27, "in", "both");
    ...
    if (!configuration.hasOwnProperty('UPS') || configuration.UPS == "UPS_APIO") {
        ...
        PIN_23.watch(function (err, value) {
            ...
            if (value == 0) {
                ...
                //                 request.post("http://localhost:" + configuration.http.port + "/apio/shutdownBoard", function (error, response, body) {
