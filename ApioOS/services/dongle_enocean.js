...
var enoceanAppliance = function (data) {
    if (chipIdWait) {
        console.log("chipIdWait, data: ", data);
        if (data.hasOwnProperty('packetType') && data.packetType == 2) {
            enocean.base = data.raw.toString('hex').substring(18, 26);
            console.log("----------------------------------------");
            console.log("enocean.base: ", enocean.base);
            console.log("----------------------------------------");

            if (enocean.base) {
                console.log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
                console.log("ENOCEAN.BASE ARRIVATO");
                console.log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
                chipIdWait = 0;
            } else {
                console.log("############################");
                console.log("NO ENOCEAN.BASE");
                console.log("############################");
...
var enoceanSend = function (enROR, enPacketType, enData, enDestinationId, enLearn) {
    try {
        ...
        console.log("enoceanSend, caught exception: ", exception);
    }
}

var enoceanSendToDevice = function (data, enocean, addInfo) {
    console.log("**********************");
    console.log("enoceanSendToDevice");
    console.log("data: ", data);
    console.log("enocean: ", enocean);
    ...
    try {
        ...
        console.log("enoceanSendToDevice, caught exception: ", exception);
    }
}
...
var enoceanInit = function (port) {
    ...
    var baseInterval = setInterval(function () {
        if (chipIdWait) {
            ...
            console.log("*************************");
            console.log("ENOCEAN.BASE DEFINITO", enocean.base);
            console.log("*************************");
...
/*com.list(function (err, ports) {
 ...
 //console.log(port);
 if (String(port.manufacturer) === "EnOcean_GmbH") {
 preEnoceanFound = 1;
 enoceanInit(port);
 }
 });
